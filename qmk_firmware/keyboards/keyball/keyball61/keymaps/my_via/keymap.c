...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    KC_LSFT  , KC_A     , KC_S     , KC_D     , KC_F     , KC_G     ,                                  KC_H     , KC_J     , KC_K     , KC_L     , KC_MINS  , KC_QUOT  ,
    KC_LCTL  , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     , KC_LBRC  ,              KC_RBRC, KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , KC_BSLS  ,
    _______  , KC_LWIN  , KC_LALT  , KC_F7,LT(1,KC_LNG2),LT(2,KC_SPC),LT(3,KC_LNG1),          KC_BSPC,LT(2,KC_ENT),LT(1,KC_LNG2),KC_RGUI, _______ , KC_F2  , KC_DEL
  ),
  ...
  [2] = LAYOUT_universal(
    ...
    _______ , _______  , KC_BTN3  , KC_BTN1  , KC_BTN2  ,_______,                                     KC_PGUP  , KC_BTN1  , KC_BTN2  , _______  , KC_BTN3  , _______  ,
    _______  , _______  , _______ , _______  , _______  ,_______, S(KC_8)  ,               S(KC_9)  , KC_PGDN  , _______  , KC_BTN4  , KC_BTN5  , _______  , _______  ,
  ...
  [3] = LAYOUT_universal(
    ...
    _______ , _______  , KC_LEFT  , KC_DOWN  , KC_RGHT  , KC_BTN1  ,                                    _______  , KC_LEFT  , KC_DOWN  , KC_RGHT  , _______ , _______  ,
